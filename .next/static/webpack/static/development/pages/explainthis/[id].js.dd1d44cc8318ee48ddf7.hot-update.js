...
function (_React$Component) {
  ...
  function ExplainThis(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this), "incrementExplanation", function () {
      var newIndex = explanationIndex == _this.data.explanations.length ? 0 : _this.state.explanationIndex + 1;

      _this.setState({
        explanationIndex: _this.state.explanationIndex + 1
      });

      console.log('in incrementExplanation, new index is', _this.state.explanationIndex);
    });
...
//# sourceMappingURL=[id].js.dd1d44cc8318ee48ddf7.hot-update.js.map