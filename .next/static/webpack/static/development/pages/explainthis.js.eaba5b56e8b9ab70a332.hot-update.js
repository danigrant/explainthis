...
function _addVote() {
  ...
  _regenerator["default"].mark(function _callee5(concept, explanationID) {
    var docID, explanationsRef, vote;
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return getExplanationDocID(concept);

          case 2:
            docID = _context5.sent;
            explanationsRef = conceptsRef.doc(docID);
            vote = {
              "datetime": firebase.firestore.Timestamp.now(),
              "user": "@barackobama",
              "vote": 1
...
//# sourceMappingURL=explainthis.js.eaba5b56e8b9ab70a332.hot-update.js.map