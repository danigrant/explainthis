...

      {
        if (!this.props.currentExplanation) {
          ...
          return __jsx("div", {
            ...
            __self: this
          }, "".concat(this.props.currentExplanation.author, " explains ").concat(this.props.currentExplanation.concept))), !this.props.profilepage && __jsx(next_link__WEBPACK_IMPORTED_MODULE_9___default.a, {
...
//# sourceMappingURL=[id].js.4f10dac48f64592a1ba8.hot-update.js.map